...
DD3D_API void DebugDraw::Position(const Vector3 &position, const Color &color, const real_t &duration) {
	DebugDraw::Position(Transform3D(Basis(), position), color, duration);
}
